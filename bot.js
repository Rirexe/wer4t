...
const TOKEN = "NTM1NDU0ODAxODMyNTc0OTg2.DyIj4Q.q8MINBtjeFzeeG_tyM3yDXNxCys";
...
client.on('ready', () => {
   console.log(`----------------`);
    ...
    console.log(`---------------`);
  console.log(`Logged in as ${client.user.tag}!`);
  client.user.setGame(`Slover  -help`,"http://twitch.tv/y04zgamer")
...
client.login("NTM1NDU0ODAxODMyNTc0OTg2.DyIhnQ.-oyv7tRMzQbTUpJOdgPCcbM4rio");